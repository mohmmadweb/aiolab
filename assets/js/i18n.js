...
const DICT = {
  fa: {
    ...
    "nav.courses": "آکادمی آیولب",
    "nav.community": "جامعه آزمایشگاهی",
    "nav.faq": "سؤالات پرتکرار",
    "nav.services": "خدمات و تعرفه",
    "nav.pricing": "تعرفه‌ها",
    "nav.reports": "گزارش بازار کار",
    "nav.advertise": "تبلیغات و همکاری",
    "svc.title": "خدمات آیولب",
    "svc.sub": "همه سرویس‌های آیولب برای کارجو، آزمایشگاه و تأمین‌کننده — با قیمت شفاف.",
    "svc.forSeeker": "کارجویان",
    "svc.forLab": "آزمایشگاه‌ها",
    "svc.forSupplier": "تأمین‌کنندگان",
    "svc.order": "سفارش این خدمت",
    "svc.free": "رایگان",
    "price.title": "تعرفه‌ها و اشتراک‌ها",
  ...
  en: {
    ...
    "nav.courses": "Aiolab Academy",
    "nav.community": "Community",
    "nav.faq": "FAQ",
    "nav.services": "Services & Pricing",
    "nav.pricing": "Pricing",
    "nav.reports": "Market Report",
    "nav.advertise": "Advertise",
    "svc.title": "AioLab Services",
    "svc.sub": "Every AioLab service for job seekers, laboratories and suppliers — transparent pricing.",
    "svc.forSeeker": "Job seekers",
    "svc.forLab": "Laboratories",
    "svc.forSupplier": "Suppliers",
    "svc.order": "Order this service",
    "svc.free": "Free",
    "price.title": "Pricing & Subscriptions",
  ...
  ar: {
    ...
    "nav.magazine": "المجلة",
    "nav.courses": "أكاديمية آيولاب",
    "nav.community": "المجتمع",
    "nav.faq": "الأسئلة الشائعة",
    "nav.services": "الخدمات والأسعار",
    "nav.pricing": "الأسعار",
    "nav.reports": "تقرير سوق العمل",
    "nav.advertise": "الإعلانات",
    "svc.title": "خدمات آيولاب",
    "svc.sub": "جميع خدمات آيولاب للباحثين عن عمل والمختبرات والموردين — بأسعار شفافة.",
    "svc.forSeeker": "الباحثون عن عمل",
    "svc.forLab": "المختبرات",
    "svc.forSupplier": "الموردون",
    "svc.order": "اطلب هذه الخدمة",
    "svc.free": "مجاني",
    "price.title": "الأسعار والاشتراكات",
